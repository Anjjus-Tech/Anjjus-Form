    ...
    <FromWrapper onSubmit={handleSubmit(onSubmit)}>
      ...
      <FormRowWrapper>
        ...
        <Input placeholder={'Data de Nascimento'} 
          ...
          onMouseOver={() => {clearErrors("birthDate")}} {
          ...register("birthDate", {
            required: "Esse campo é obrigatório" 
          }
        )} />
      ...
      <InputWrapper>
        <Input placeholder={'Número de celular'} 
          ...
          onMouseOver={() => {clearErrors("phone")}} {
          ...register("cellphone", {
            required: "Esse campo é obrigatório" 
          }
        )} />
        {errors && errors.cellphone && (<ErrorMsg>{errors.cellphone.message as string}</ErrorMsg>)}
      </InputWrapper>
      <InputWrapper>
        <Input placeholder={'Sexo'} 
          defaultValue={client.sex || ""}
          onMouseOver={() => {clearErrors("sex")}} {
          ...register("sex", {
            required: "Esse campo é obrigatório" 
          }
        )} />
      ...
      <InputWrapper>
        <Input placeholder={'Tipo de documento'} 
          ...
          onMouseOver={() => {clearErrors("identificationDocType")}} {
      ...
      <InputWrapper>
        <Input placeholder={'Numero do documento'} 
          ...
          onMouseOver={() => {clearErrors("identificationDocNumber")}} {
      ...
      <InputWrapper>
        <Input placeholder={'Orgão emissor'} 
          ...
          onMouseOver={() => {clearErrors("issuer")}} {
          ...register("issuer", {
            required: "Esse campo é obrigatório" 
          }
        )} />
      ...
      <InputWrapper>
        <Input placeholder={'Data de expedição'} 
          ...
          onMouseOver={() => {clearErrors("issueDate")}} {
          ...register("issueDate", {
            required: "Esse campo é obrigatório" 
          }
        )} />
